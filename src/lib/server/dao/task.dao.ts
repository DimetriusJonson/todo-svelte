...
export async function findTaskByTitle(input: string, ignoreId: number, params: any): Promise<Task | null> {
...
export async function findTaskById(params: any, id: number): Promise<Task> {
...
export async function findTasks(params: any): Promise<Task[]> {
...
export async function dbUpdateTask(params: any, patch: Task): Promise<Task> {
...
export async function dbInsertTask(params: any, task: Task): Promise<Task> {
...
export async function dbDeleteTask(params: any, id: number): Promise<boolean> {
